...
import com.example.information_schema.tables.records.InnodbFtIndexCacheRecord;
...
public class InnodbFtIndexCache extends TableImpl<InnodbFtIndexCacheRecord> {
	...
	private static final long serialVersionUID = -1309383152;
	 ...
	 */
	public final TableField<InnodbFtIndexCacheRecord, String> WORD = createField("WORD", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false).defaulted(true), this, "");
