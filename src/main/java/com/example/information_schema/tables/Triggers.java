...
import com.example.information_schema.tables.records.TriggersRecord;
...
public class Triggers extends TableImpl<TriggersRecord> {
	...
	private static final long serialVersionUID = -229756443;
	 ...
	 */
	public final TableField<TriggersRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR.length(77).nullable(false).defaulted(true), this, "");
