...
import com.example.sys.tables.records.X$statementsWithRuntimesIn_95thPercentileRecord;
...
public class X$statementsWithRuntimesIn_95thPercentile extends TableImpl<X$statementsWithRuntimesIn_95thPercentileRecord> {
	...
	private static final long serialVersionUID = 1756409103;
	 ...
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, String> DB = createField("db", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "");

	/**
	 * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.full_scan</code>.
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(1).nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, BigInteger> ROWS_SENT_AVG = createField("rows_sent_avg", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(21).nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, BigInteger> ROWS_EXAMINED_AVG = createField("rows_examined_avg", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(21).nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.first_seen</code>.
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.last_seen</code>.
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.digest</code>.
	 */
	public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR.length(32), this, "");
	...
	public X$statementsWithRuntimesIn_95thPercentile() {
		this("x$statements_with_runtimes_in_95th_percentile", null);
	}
	...
	private X$statementsWithRuntimesIn_95thPercentile(String alias, Table<X$statementsWithRuntimesIn_95thPercentileRecord> aliased) {
		this(alias, aliased, null);
	}

	private X$statementsWithRuntimesIn_95thPercentile(String alias, Table<X$statementsWithRuntimesIn_95thPercentileRecord> aliased, Field<?>[] parameters) {
