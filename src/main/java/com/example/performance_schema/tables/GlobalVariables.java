...
import com.example.performance_schema.tables.records.GlobalVariablesRecord;
...
public class GlobalVariables extends TableImpl<GlobalVariablesRecord> {
	...
	private static final long serialVersionUID = -1638418924;
	 ...
	 */
	public final TableField<GlobalVariablesRecord, String> VARIABLE_NAME = createField("VARIABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");
