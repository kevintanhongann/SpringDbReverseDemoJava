...
import com.example.performance_schema.tables.records.SocketSummaryByEventNameRecord;
...
public class SocketSummaryByEventName extends TableImpl<SocketSummaryByEventNameRecord> {
	...
	private static final long serialVersionUID = -1309203253;
	 ...
	 */
	public final TableField<SocketSummaryByEventNameRecord, String> EVENT_NAME = createField("EVENT_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false), this, "");
	...
	public SocketSummaryByEventName() {
		this("socket_summary_by_event_name", null);
	}
	...
	private SocketSummaryByEventName(String alias, Table<SocketSummaryByEventNameRecord> aliased) {
		this(alias, aliased, null);
	}

	private SocketSummaryByEventName(String alias, Table<SocketSummaryByEventNameRecord> aliased, Field<?>[] parameters) {
