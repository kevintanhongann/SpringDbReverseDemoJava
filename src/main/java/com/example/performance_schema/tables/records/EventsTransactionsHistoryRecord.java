...
public class EventsTransactionsHistoryRecord extends TableRecordImpl<EventsTransactionsHistoryRecord> {
	...
	private static final long serialVersionUID = 1383763069;
	...
	public EventsTransactionsHistoryState getState() {
		return (EventsTransactionsHistoryState) getValue(4);
	}
	...
	public EventsTransactionsHistoryAccessMode getAccessMode() {
		return (EventsTransactionsHistoryAccessMode) getValue(15);
	}
	...
	public EventsTransactionsHistoryAutocommit getAutocommit() {
		return (EventsTransactionsHistoryAutocommit) getValue(17);
	}
	...
	public EventsTransactionsHistoryNestingEventType getNestingEventType() {
		return (EventsTransactionsHistoryNestingEventType) getValue(23);
	}
