...
import com.example.performance_schema.tables.records.TableIoWaitsSummaryByTableRecord;
...
public class TableIoWaitsSummaryByTable extends TableImpl<TableIoWaitsSummaryByTableRecord> {
	...
	private static final long serialVersionUID = 1437797984;
	 ...
	 */
	public final TableField<TableIoWaitsSummaryByTableRecord, String> OBJECT_TYPE = createField("OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "");

	/**
	 * The column <code>performance_schema.table_io_waits_summary_by_table.OBJECT_SCHEMA</code>.
	 */
	public final TableField<TableIoWaitsSummaryByTableRecord, String> OBJECT_SCHEMA = createField("OBJECT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "");

	/**
	 * The column <code>performance_schema.table_io_waits_summary_by_table.OBJECT_NAME</code>.
	 */
	public final TableField<TableIoWaitsSummaryByTableRecord, String> OBJECT_NAME = createField("OBJECT_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "");
	...
	private TableIoWaitsSummaryByTable(String alias, Table<TableIoWaitsSummaryByTableRecord> aliased) {
		this(alias, aliased, null);
	}

	private TableIoWaitsSummaryByTable(String alias, Table<TableIoWaitsSummaryByTableRecord> aliased, Field<?>[] parameters) {
