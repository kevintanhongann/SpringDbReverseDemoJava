...
import com.example.performance_schema.tables.records.EventsStatementsSummaryByHostByEventNameRecord;
...
public class EventsStatementsSummaryByHostByEventName extends TableImpl<EventsStatementsSummaryByHostByEventNameRecord> {
	...
	private static final long serialVersionUID = -846436041;
	 ...
	 */
	public final TableField<EventsStatementsSummaryByHostByEventNameRecord, String> HOST = createField("HOST", org.jooq.impl.SQLDataType.CHAR.length(60), this, "");

	/**
	 * The column <code>performance_schema.events_statements_summary_by_host_by_event_name.EVENT_NAME</code>.
	 */
	public final TableField<EventsStatementsSummaryByHostByEventNameRecord, String> EVENT_NAME = createField("EVENT_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false), this, "");
	...
	private EventsStatementsSummaryByHostByEventName(String alias, Table<EventsStatementsSummaryByHostByEventNameRecord> aliased) {
		this(alias, aliased, null);
	}

	private EventsStatementsSummaryByHostByEventName(String alias, Table<EventsStatementsSummaryByHostByEventNameRecord> aliased, Field<?>[] parameters) {
